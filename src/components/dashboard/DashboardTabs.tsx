...
const DashboardTabs: React.FC<DashboardTabsProps> = ({
  ...
  return (
    ...
    >
      <TabsList className="grid w-full grid-cols-6 mb-8 bg-gray-50 border border-gray-200 rounded-lg overflow-hidden p-1 h-full">
        <TabsTrigger
          value="analytics"
        ...
        <a
          href="https://preview--get-new-registration-29.lovable.app/"
          target="_blank"
          rel="noopener noreferrer"
          className="text-center data-[state=active]:bg-white data-[state=active]:text-gray-700 border-r border-gray-200 hover:bg-gray-100 transition-colors font-medium flex items-center justify-center h-full text-sm"
        >
