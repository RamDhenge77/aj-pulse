...
const LandingPage = () => {
    ...
    return (
      <div className="w-full h-full aspect-video">
        <iframe
          ...
          src="https://www.youtube.com/embed/X6eQRUgIATI?autoplay=1&controls=0&mute=1&loop=1&playlist=X6eQRUgIATI&modestbranding=1&rel=0"
  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <div className="relative w-full flex-grow h-[calc(100vh-13rem)]">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <InfoCard
              ...
              title="Get Premium Recommendation"
