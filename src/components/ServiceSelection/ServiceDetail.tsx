    ...
    <div className="border rounded-lg overflow-hidden bg-white shadow-sm h-full flex flex-col">
      <div className="aspect-video relative rounded-t-md overflow-hidden bg-gray-100">
        <img
          ...
          onError={(e) => {
            ...
            target.src = "https://via.placeholder.com/600x400?text=" + service.name.replace(/\s+/g, '+');
          }}
        />
      </div>
      ...
      <div className="p-4 flex-1 flex flex-col">
        <div className="flex justify-between items-start mb-2">
          ...
          <span className="text-lg font-semibold text-salik-primary">AED {service.price}</span>
        </div>
          ...
          <div className="flex items-center gap-2">
            <img 
              ...
              onError={(e) => {
                ...
                target.onerror = () => {
                  target.src = `https://via.placeholder.com/32?text=${brandName.charAt(0)}`;
                  target.onerror = null;
                };
              }}
            />
        ...
        <Button
          className="w-full bg-[#2596be] hover:bg-[#2b7f9e] text-white mt-auto"
