      ...
      <div className="relative">
        <Carousel className="w-full">
          ...
          <div className="flex justify-center gap-2 mt-4">
            <CarouselPrevious className="relative inset-0 translate-y-0 left-0 hover:bg-[#2b7f9e] hover:text-white" />
            <CarouselNext className="relative inset-0 translate-y-0 right-0 hover:bg-[#2b7f9e] hover:text-white" />
          </div>
        </Carousel>
      </div>
    </div>
