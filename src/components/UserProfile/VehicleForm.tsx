...
import { VEHICLE_MAKES, VEHICLE_COLORS, INSURANCE_PROVIDERS } from "@/utils/profileUtils";
...
export const VehicleForm = ({
  ...
  const updateNewVehicleInsurance = (field: keyof Vehicle['insurance'], value: string) => {
    setNewVehicle(prev => ({
      ...prev,
      insurance: {
        ...prev.insurance,
  ...
  const updateEditingVehicleInsurance = (field: keyof Vehicle['insurance'], value: string) => {
    if (editingVehicle) {
      setEditingVehicle(prev => ({
        ...prev!,
        insurance: {
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[600px]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-[60vh] overflow-y-auto px-2 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      editingVehicle
                        ? updateEditingVehicleField("registrationNumber", e.target.value)
                        : updateNewVehicleField("registrationNumber", e.target.value)
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      editingVehicle
                        ? updateEditingVehicleField("chassisNumber", e.target.value)
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="plateCode"
                    value={editingVehicle ? editingVehicle.plateCode : newVehicle.plateCode}
                    onChange={(e) =>
                      editingVehicle
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="plateNumber"
                    value={
                      editingVehicle ? editingVehicle.plateNumber : newVehicle.plateNumber
                    }
                    onChange={(e) =>
                      editingVehicle
                        ? updateEditingVehicleField("plateNumber", e.target.value)
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="rtaTagNumber"
                    value={
                      editingVehicle ? editingVehicle.rtaTagNumber : newVehicle.rtaTagNumber
                    }
                    onChange={(e) =>
                      editingVehicle
                        ? updateEditingVehicleField("rtaTagNumber", e.target.value)
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      editingVehicle
                        ? updateEditingVehicleInsurance("policyNumber", e.target.value)
                        : updateNewVehicleInsurance("policyNumber", e.target.value)
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      editingVehicle
                        ? updateEditingVehicleInsurance("expiryDate", e.target.value)
                        : updateNewVehicleInsurance("expiryDate", e.target.value)
                    }
                  />
                </div>
              </div>
              <div className="flex justify-end gap-2">
                ...
                <Button
                  type="button"
                  className="bg-[#2596be] hover:bg-[#2b7f9e]"
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2 mt-2 text-sm text-gray-600">
                      ...
                      <p>
                        <span className="font-medium">Plate:</span> {vehicle.plateCode}-
                        {vehicle.plateNumber}
                      </p>
                      <p>
                      ...
                      <p>
                        <span className="font-medium">RTA Tag:</span> {vehicle.rtaTagNumber}
                      </p>
                    </div>

                    <div className="mt-3">
                      <Badge variant="outline" className="bg-uae-secondary/5 border-uae-secondary/20 text-uae-secondary">
