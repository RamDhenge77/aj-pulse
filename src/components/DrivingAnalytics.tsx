  ...
  return (
    ...
    >
      <TabsList className="mb-6 gap-4">
        ...
        <TabsTrigger value="speed" className="text-center data-[state=active]:bg-white data-[state=active]:text-gray-700 border-r border-gray-200 hover:bg-gray-100 transition-colors font-medium">
      ...
      <div className="space-y-8 animate-fade-in">
        ...
        <TabsContent value="analytics">
          <div className="mb-8">
            <Card className="rounded-xl border-gray-200 hover:shadow-lg transition-all duration-300">
              <CardHeader>
