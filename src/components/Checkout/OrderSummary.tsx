...
const OrderSummary: React.FC<OrderSummaryProps> = ({
  ...
  const handlePlaceOrder = () => {
    alert("Order placed! In a real app, this would process the payment and save the order.");
  };
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <div className="flex gap-4 items-center">
              ...
              <div>
                <h3 className="font-medium">{cartItem.brandName} {cartItem.modelName}</h3>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex justify-between mb-2">
              ...
              <span className="font-medium">AED {cartItem.service.price.toFixed(2)}</span>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <div>
              ...
              {paymentMethods.map((method) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    {paymentMethod === method.id && (
                      <div className="h-5 w-5 rounded-full bg-[#2596be] flex items-center justify-center">
        ...
        <div>
          <label className="font-medium block mb-2">Additional Notes / Information</label>
          <Textarea
            value={notes}
          ...
          <Button
            className="w-full bg-[#2596be] hover:bg-[#2b7f9e] py-6 text-lg"
