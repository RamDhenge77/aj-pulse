          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="max-w-xl">
              ...
              <div className="flex flex-wrap gap-4">
                <Button className="bg-[#6cd0f585] hover:bg-[#2596be] text-white px-8 py-6 text-lg" onClick={() => setRoadsideAssistance(3)}>
                  Request Service
                </Button>
                <Button
                  variant="outline"
      ...
      <div className="py-16 bg-salik-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mt-12">
            ...
            <Button
              variant="outline"
              className="bg-salik-gray-500 hover:bg-salik-gray-600"
              onClick={() => {
