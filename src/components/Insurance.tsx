  ...
  return (
    <Tabs defaultValue="insurance">
      <TabsList className="mb-6 gap-4">
        ...
        <a
          href="https://preview--auto-care-warranty-hub.lovable.app/"
          target="_blank"
          rel="noopener noreferrer"
          className="text-center data-[state=active]:bg-white data-[state=active]:text-gray-700 border-r border-gray-200 hover:bg-gray-100 transition-colors font-medium flex items-center justify-center h-full px-3 text-sm"
        >
        ...
        >
         ...
         {/* <a
          href="https://preview--mobile-rescue-hub.lovable.app/"
          target="_blank"
          rel="noopener noreferrer"
          className="text-center data-[state=active]:bg-white data-[state=active]:text-gray-700 border-r border-gray-200 hover:bg-gray-100 transition-colors font-medium flex items-center justify-center h-full px-3 text-sm"
        >
          ...
          <div className="min-h-screen bg-[#2595be12] flex flex-col items-center justify-center p-4">
            <div className="max-w-2xl w-full bg-white rounded-xl shadow-md p-6 md:p-8 space-y-6">
              ...
              <Button
                ...
                className="w-full bg-[#2596be] hover:bg-[#2b7f9e] text-white font-semibold py-6 rounded-md"
              >
                I Accept & Continue
              </Button>
            </div>
