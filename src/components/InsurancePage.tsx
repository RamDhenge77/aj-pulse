      ...
      <main className="container mx-auto px-4 py-6">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <Card className="bg-white rounded-2xl p-6 shadow-sm">
              <div className="flex justify-between items-center">
                ...
                <div className="h-12 w-12 rounded-full bg-[#2596be] text-white flex items-center justify-center">
                  <Edit size={20} />
                </div>
              </div>
            </Card>
            ...
            >
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  <div className="h-8 w-8 rounded-full bg-[#2596be] text-white flex items-center justify-center mr-4">
                    <Plus size={20} />
                  </div>
          ...
          <div className="flex justify-center mt-8">
            <Button className="bg-[#2596be] hover:bg-[#2b7f9e] text-white px-8 py-2 rounded-full text-lg">
              Proceed to Checkout
            </Button>
          </div>
        </div>
